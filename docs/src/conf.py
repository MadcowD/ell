...
extensions = [
    ...
    'sphinxawesome_theme',
    'sphinx_tabs.tabs',
    # this says it is parallel read/write safe, but it isn't
    'sphinxcontrib.autodoc_pydantic',
    'sphinx_typescript_automodule'
]
...
typescript_root_path = os.path.normpath(os.path.join(
    os.path.dirname(__file__), '..', "..", 'typescript', 'src'))
