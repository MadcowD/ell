...
const API_BASE_URL = process.env.NODE_ENV === 'development' ? 'http://localhost:5555' : window.location.origin
...
export const useInvocationsFromLMP = (name, id, page = 0, pageSize = 50, hierarchical = false, invocationId = null) => {
