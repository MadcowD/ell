...
const MetricChart = ({ rawData, dataKey, aggregation, yAxisLabel, title, color }) => {
    ...
    const filteredTimeRangeOptions = useMemo(() => timeRangeOptions.filter((range) => {
        ...
        <div className="bg-card p-2 rounded">
            ...
            <div className="h-48">
                <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={aggregatedData} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
                        <defs>
                        ...
                        />
                        <Brush dataKey="date" height={15} stroke={color} fill="#2D3748" tickFormatter={formatXAxis} />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
        </div>
