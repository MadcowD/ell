...
def init(
    ...
    """
    Initialize the ELL2A configuration with various settings.

    :param verbose: Set verbosity of ELL2A operations.
    :type verbose: bool
    :param store: Set the store for ELL2A. Can be a Store instance or a string path for SQLiteStore.
...
def set_store(*args, **kwargs) -> None:
    raise DeprecationWarning("The set_store function is deprecated and will be removed in a future version. Use ell2a.init(store=...) instead.")