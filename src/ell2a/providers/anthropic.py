...
from ell2a.types import Message, ContentBlock, ToolCall, ImageContent
...
try:
    ...
    class AnthropicProvider(Provider):
        ...
        def translate_to_provider(self, ell_call : EllCallParams): 
            ...
            assert final_call_params.get("max_tokens") is not None, f"max_tokens is required for anthropic calls, pass it to the @ell2a.simple/complex decorator, e.g. @ell2a.simple(..., max_tokens=your_max_tokens) or pass it to the model directly as a parameter when calling your LMP: your_lmp(..., api_params=({{'max_tokens': your_max_tokens}}))."
