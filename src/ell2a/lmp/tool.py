...
# from ell2a.types import ToolFunction, InvocableTool, ToolParams
# from ell2a.util.verbosity import compute_color, tool_usage_logger_pre
from ell2a.configurator import config
from ell2a.types._lstr import _lstr
from ell2a.types.studio import LMPType
import inspect

from ell2a.types.message import ContentBlock, InvocableTool, ToolResult, to_content_blocks
            ...
            **fn_kwargs
            ...
            if _tool_call_id:
                ...
                try:
                    ...
                    raise TypeError(f"Failed to convert tool use result to ContentBlock: {e}. Agents must return json serializable objects. or a list of ContentBlocks.")
                ...
                for c in content_results:
                    assert not c.tool_call, "Agent call in tool result"
...
Example::
    ...
    @ell2a.complex(model="gpt-4", tools=[create_claim_draft], temperature=0.1)
...
Note:
- Agents are integrated into LMP calls via the 'tools' parameter in @ell2a.complex.
