...
@ell.simple(model="gpt-4o-mini", temperature=1.0, max_tokens=15)
...
@ell.simple(model="gpt-4o", temperature=0.1, max_tokens=15)
def choose_the_best_draft(drafts : List[str]):
    """You are an expert fiction editor."""
    return f"Choose the best draft from the following list: {'\n'.join(drafts)}."

@ell.simple(model="gpt-4-turbo", temperature=0.2, max_tokens=15)
